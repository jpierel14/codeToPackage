...
sphinx_gallery_conf = {
    ...
    'doc_module': ('codetopackage',),  # documented module(s)
...
htmlhelp_basename = 'codetopackage'+'doc'
...
latex_documents = [
    (master_doc, 'codetopackage'+'.tex', 'codetopackage'+' Documentation',
...
man_pages = [
    (master_doc, 'codetopackage', 'codetopackage'+' Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'codetopackage', 'codetopackage'+' Documentation',
     author, 'codetopackage', 'One line description of project.',
     'Miscellaneous'),
]
